...
`,
  `
- En la sección *Assets*, añade la moneda pCOLE, la que tiene la palomita verde (lo que quiere decir que es la original).
...
`;
let huboError =
  "Hubo un error... Sería muy amable de tu parte si lo reenviaras a nuestro bot de soporte @ColeCoinSoporteBot para poder analizarlo.\n\n";
let sinRecompensas = `
*¿Quieres ganar más COLEs?*
